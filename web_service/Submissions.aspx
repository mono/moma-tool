            ...
            <asp:UpdatePanel ID="ReportsGridUpdatePanel" runat="server">
                <ContentTemplate>
                    ...
                    <asp:SqlDataSource ID="ProfileSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:MomaDB %>"
                        ProviderName="<%$ ConnectionStrings:MomaDB.ProviderName %>" 
                        SelectCommand="SELECT display_name FROM moma_definition ORDER BY create_date DESC;"
                        EnableCaching="True" CacheDuration="300">
                    </asp:SqlDataSource>
                    <div id="sidebar">
                        <h2>Filter</h2>
                        <h3>Importance:</h3>
                        <asp:CheckBoxList ID="ImportanceCheckBoxList" runat="server">
                            <asp:ListItem>Important</asp:ListItem>
                            <asp:ListItem>Useful</asp:ListItem>
                            <asp:ListItem>Not useful</asp:ListItem>
                        </asp:CheckBoxList>
                        <h3>Application Name:</h3>
                        <asp:TextBox ID="AppNameFilterTextBox" runat="server"></asp:TextBox>
                        <h3>Application Type:</h3>
                        <asp:TextBox ID="AppTypeFilterTextBox" runat="server"></asp:TextBox>
                        <h3>Profile:</h3>
                        <asp:DropDownList ID="ProfileFilterDropDownList" runat="server" DataSourceID="ProfileSqlDataSource"
                    ...
                    <asp:GridView ID="ReportsGridView" runat="server" DataSourceID="SubmissionsSqlDataSource"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="&nbsp;" SortExpression="importance">
                                <ItemTemplate>
                                    <asp:Image ID="ImportanceImage" runat="server" ImageUrl='<%# "~/" + Eval("importance").ToString().ToLower() + ".png" %>' Visible='<%# Eval("importance").ToString() != "" %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="application_name" HeaderText="App Name" 
                                SortExpression="application_name" />
                            <asp:BoundField DataField="application_type" HeaderText="App Type" 
